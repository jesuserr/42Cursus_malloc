...
#    Updated: 2024/10/17 11:53:35 by jesuserr         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
NAME = allocator
SRCS = main.c malloc.c free.c inits.c utils.c realloc.c calloc.c
SRCS_NORM = malloc.c free.c inits.c utils.c realloc.c calloc.c
PATH_SRCS = ./srcs/
PATH_OBJS = ./srcs/objs/
PATH_DEPS = ./srcs/objs/
